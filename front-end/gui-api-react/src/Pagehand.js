...
const Pagehand = (props) => {               // Page handling
    const { pageNext, pagePrevious, setPage, page } = props
    return (
        <div className="row">
            <Pagination pageNext={pageNext} pagePrevious={pagePrevious}/>
            <PageSetting setPage={setPage} page={page} />
        </div>
    )
}

export default Pagehand
